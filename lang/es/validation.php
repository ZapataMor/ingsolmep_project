...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Mensajes de error por defecto del validador. Algunas reglas tienen varias
    | versiones (numérica, de archivo, de cadena y de arreglo) según el tipo del
    | valor evaluado.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El valor del campo :attribute apareció en una filtración de datos. Elija otro valor.',
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Aquí se define un mensaje propio para una combinación concreta de campo y
    | regla, usando la convención «campo.regla».
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Reemplaza :attribute por un nombre legible. Los formularios de Livewire
    | pueden pasar sus propios nombres al validar.
    |
    */
