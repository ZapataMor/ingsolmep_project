...
<link rel="icon" href="{{ asset('images/icono-32.png') }}" sizes="32x32" type="image/png">
<link rel="icon" href="{{ asset('images/icono-512.png') }}" sizes="512x512" type="image/png">
<link rel="apple-touch-icon" href="{{ asset('images/icono-180.png') }}">
